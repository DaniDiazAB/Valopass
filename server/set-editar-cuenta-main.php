...
try {
    ...
    $sql = "UPDATE cuenta_main SET nombre_cuenta_main = :nick, tag_cuenta_main = :tag, elo_cuenta_main = :rango WHERE id_usuario_cuenta_main = :id_usuario";
